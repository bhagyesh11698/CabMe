...
export default function Register() {
  ...
  return (
    ...
    <div className="container py-5">
        ...
        <h6 className="text-primary text-uppercase" style={{"letter-spacing": "5px"}}>Register</h6>
            ...
            <div className="col-lg-8">
                <div className="contact-form bg-white" style={{"padding": "30px", "border-radius": "10px"}}>
                    ...
                    <form name="sentMessage" id="contactForm" novalidate="novalidate">
                            ...
                            <div className="row mb-3">
                                <label htmlFor="inputPassword3" className="col-sm-2 col-form-label">Contact</label>
                                <div className="col-sm-10">
                                <input type="text" 
                                 onChange={(e) =>
                                    setPostData({ ...postData, contact: e.target.value })}
                                    className="form-control" id="inputcontact" />
                                </div>
                            </div>
